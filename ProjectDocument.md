...
- Caz : Building the narrative and handling the player inputs among other contributions. 
        [Narrative design](https://github.com/shreyagupta98/MochiGaDaisukiFinal/blob/master/ProjectDocument.md#narrative-design) + 
        [Input](https://github.com/shreyagupta98/MochiGaDaisukiFinal/blob/master/ProjectDocument.md#input)
